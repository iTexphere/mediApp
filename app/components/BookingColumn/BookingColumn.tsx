...
<Text style={[styles.bookingNo,{color:'red', fontWeight:'bold'}]}>{ongoingNo}</Text>
        ...
        <View style={styles.currentBookingNuber}><Text style={[styles.bookingNo,{color:'green', fontWeight:'bold'}]}>No Booking Available</Text></View>
      )}
